            ...
            <section className='contactContent'>
                ...
                <div className='contactForm'>
                    ...
                    <div className='contactFormName'>
                        <p> Your Name</p>
                        <input type='text' onChange={(e) => { handleForm('name', e.target.value) }} value={contactForm.name} disabled/>
                    </div>
                    <div className='contactFormEmail'>
                        <p> Email </p>
                        <input type='email' onChange={(e) => { handleForm('email', e.target.value) }} value={contactForm.email} disabled />
                    </div>
                    <div className='contactFormMessage'>
                        <p> Message</p>
                        <textarea placeholder='Message' onChange={(e) => { handleForm('message', e.target.value) }} value={contactForm.message} disabled/>
                    </div>
